...
public class Coin extends Item {
    ...
    public Coin(float x, float y,int width, int height, Stage s,int row,int col, CradleGame cradleGame)
    {
    ...
    public void setLockLevel(int lockLevel) {
        if (cradleGame.getGameMapLevel()!=4){
            ...
            switch (lockLevel){
                ...
                case 1:
                    if (lockImage01==null){
                        lockImage01 = AddImage("coin1_frosen.png",0,0, (int) getWidth(), (int) getHeight());
                    }
                    if (this.lockLevel ==0){
