...
public class LevelOfHardnessDialogBox extends DialogBox {
    ...
    public LevelOfHardnessDialogBox(float x, float y, Stage s, int width, int height, CradleGame cradleGame1) {
        ...
        easyButton = new TextButton( ms, BaseGame.textButtonStyle );
        ...
        middleButton = new TextButton( ms, BaseGame.textButtonStyle );
        ...
        hardButton = new TextButton( ms, BaseGame.textButtonStyle );
